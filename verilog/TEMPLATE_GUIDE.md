...
### 📝 Edit `scripts/build_tools/config.tcl`
...
- ✅ `scripts/build_tools/config.tcl` - **Edit this for new projects**
- ✅ `scripts/build_tools/build.tcl` - Uses config (no manual editing needed)
- ✅ `scripts/build_tools/program.tcl` - Uses config (no manual editing needed)
- ✅ `scripts/build_tools/build.ps1` - Uses config indirectly (no manual editing needed)
