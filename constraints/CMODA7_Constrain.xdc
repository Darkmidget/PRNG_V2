...
## AS608 UART (DIP pins 6, 7)
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { as608_tx }]; # DIP 6 / pio6
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 PULLUP true } [get_ports { as608_rx }]; # DIP 7 / pio7
