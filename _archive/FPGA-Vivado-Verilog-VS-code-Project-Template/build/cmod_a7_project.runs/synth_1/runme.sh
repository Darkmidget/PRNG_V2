...
HD_PWD='G:/My Drive/0 - SUTD/Term 6/DSL/Project/verilog/FPGA-Vivado-Verilog-VS-code-Project-Template/build/cmod_a7_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lfsr_nl_seed_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lfsr_nl_seed_uart.tcl
